...
import Types exposing (ApiActionResponse, Concept, ConceptTag, Model, Msg(..), Page(..), Problem(..), Transaction, TransactionForm, TransactionFromType(..), TransactionType(..), User, ValidatedField(..), apiActionDecoder, authHeader, formatBalance, formatDate, tgsLocale)
...
pageTransactionPending model =
    List.concat
        ...
        , Types.transactionDetailedSummary model model.pendingTransactions
        , [ Html.br [] []
          , Html.br [] []
          , Html.br [] []
          , Html.br [] []
